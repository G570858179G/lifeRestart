...
class App{
    ...
    initPages() {
        ...
        groups.CHR = getBtnGroups("颜值", 999, 999); // 颜值 charm CHR
        groups.INT = getBtnGroups("智力", 999, 999); // 智力 intelligence INT
        groups.STR = getBtnGroups("体质", 999, 999); // 体质 strength STR
        groups.MNY = getBtnGroups("家境", 999, 999); // 家境 money MNY
